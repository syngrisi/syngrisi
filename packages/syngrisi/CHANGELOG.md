...
-   e092c82: CORS & Embed: admin-managed credentialed cross-origin Accept (e.g. from Jenkins Allure) without sharing an API key.
...
-   @syngrisi/node-resemble.js@3.18.0
...
-   2aeeb17: RCA (Root Cause Analysis) is now a persistent admin setting. Admins can toggle
...
-   @syngrisi/node-resemble.js@3.16.0

## 3.15.1

### Patch Changes

-   601daff: Fix a 500 (`StrictPopulateError`) on list endpoints when a client sends a
    ...
    throwing.
    -   @syngrisi/node-resemble.js@3.15.1

## 3.15.0

### Minor Changes

-   1580922: Security & correctness hardening batch (audit-driven):
...
-   Updated dependencies [67f3c32]
    -   @syngrisi/node-resemble.js@3.15.0

## 3.14.1

### Patch Changes

-   2355e71: Add UI e2e coverage and documentation for baseline promotion and per-project retention.
    ...
    -   @syngrisi/node-resemble.js@3.14.1
...
-   Updated dependencies [9b6729d]
    -   @syngrisi/node-resemble.js@3.10.0

## 3.9.2

### Patch Changes

-   a87f626: Harden the AI Triage / RCA subsystem and fix several admin-panel bugs
    ...
    -   @syngrisi/node-resemble.js@3.9.2
...
-   f0fcb4c: AI Triage gating, preview card menu and Backup page fix
...
-   @syngrisi/node-resemble.js@3.9.0
...
-   Updated dependencies []:
    -   @syngrisi/node-resemble.js@3.2.0
