...
The OIDC app is configured with redirect URIs for E2E parallel workers:
- `http://localhost:3002/v1/auth/sso/oauth/callback` (worker 0)
- `http://localhost:3003/v1/auth/sso/oauth/callback` (worker 1)
- ... up to port 3011 (10 parallel workers supported)
