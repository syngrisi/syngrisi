...
Feature: Standard Checks Flow - UI
  ...
  Scenario: Status View - Standard Flow
    ...
    Then the css attribute "color" from element "[data-check-status-name='CheckName-StandardFlow']" is "rgba(34,139,230,1)"
    ...
    Then the css attribute "color" from element "[data-check-status-name='CheckName-StandardFlow']" is "rgba(64,192,87,1)"
    Then the element with locator "[data-test='check-accept-icon'] svg" should have has attribute "data-test-icon-type=outline"
    Then the css attribute "color" from element "[data-test='check-accept-icon'] svg" is "rgba(64,192,87,1)"
    ...
    Then the css attribute "color" from element "[data-check-status-name='CheckName-StandardFlow']" is "rgba(250,82,82,1)"
    Then the element with locator "[data-test='check-accept-icon'] svg" should have has attribute "data-test-icon-type=outline"
    Then the css attribute "color" from element "[data-test='check-accept-icon'] svg" is "rgba(64,192,87,1)"
