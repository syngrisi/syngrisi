...
Feature: Remove item
  ...
  Scenario: Remove Run
    ...
    When I wait 10 seconds for the element with locator "[data-item='remove-popover-action-icon_confirm']" to be visible
    When I click element with locator "[data-item='remove-popover-action-icon_confirm']"

    When I wait 10 seconds for the element with locator "[data-test='remove-item-modal-button']" to be visible
    ...
    When I wait 10 seconds for the element with locator "//*[contains(@class, 'mantine-Notification-body')]//div[text()='Run has been successfully removed']" to be visible
  ...
  Scenario: Remove Suite
    ...
    When I wait 10 seconds for the element with locator "//*[contains(@class, 'mantine-Notification-body')]//div[text()='Success']" to be visible
    When I wait 10 seconds for the element with locator "//*[contains(@class, 'mantine-Notification-body')]//div[text()='Suite has been successfully removed']" to be visible
